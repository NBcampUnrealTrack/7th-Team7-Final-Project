...
### Guardian of the Sleeping Island
...
> 8인 팀 · 약 46일. 실제 담당 파트로 채워 넣으세요. *(핸들 출처: `CODEOWNERS`)*

<br/>

| GitHub | 파트 | 담당 |
|:---|:---|:---|
| [@dooyeonk](https://github.com/dooyeonk) · [@kbrother102](https://github.com/kbrother102) · [@jcmeve](https://github.com/jcmeve) · [@yoonseo4343](https://github.com/yoonseo4343) · [@ood11611doo](https://github.com/ood11611doo) · [@eunseoGithub](https://github.com/eunseoGithub) · [@hyun0619](https://github.com/hyun0619) · [@saltlake00](https://github.com/saltlake00) | Client / Server | *(전투 · 카메라 · AI · UI · 툴 · 네트워크 · 인프라 …)* |

<br/>

**본인 주요 기여** *(포트폴리오용 — 직접 채우기)*

| 담당 | 내용 |
|:---|:---|
| *(시스템)* | 예) GAS *Fragment·Logic·Injector* 전투 아키텍처 설계 · 패링/차지 구현 |
| *(시스템)* | 예) `GYCameraComponent` 카메라 프레임워크 + 타격감 파이프라인 |
| *(툴)* | 예) 스킬 트리 커스텀 그래프 에디터 / 아이템 에디터 스위트 |
| *(온라인)* | 예) Steam·Supabase 세션 오케스트레이션 · 서버 권한 세이브 |
...
**MIT License** (루트에 `LICENSE` 파일 추가 권장).

<br/>

<div align="center">

**잠든 섬의 파수꾼** *(가제)* · 내일배움캠프 Unreal 트랙 7기 · 7팀 최종 프로젝트

...
namespace GYGameplayTags
{
	...
	GY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Block)
	GY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_Parkour)
	GY_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(InputTag_LockOn)
}

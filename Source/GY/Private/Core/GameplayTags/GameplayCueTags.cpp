...
namespace GYGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Player_Stagger_Level1, "GameplayCue.Player.Stagger.Level1")
	UE_DEFINE_GAMEPLAY_TAG(GameplayCue_Player_Down_Level2, "GameplayCue.Player.Down.Level2")

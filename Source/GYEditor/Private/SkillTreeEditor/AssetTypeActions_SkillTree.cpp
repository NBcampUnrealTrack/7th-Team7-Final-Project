...
FText   FAssetTypeActions_SkillTree::GetName()           const { return NSLOCTEXT("SkillTree", "Name", "Skill Tree"); }
FColor  FAssetTypeActions_SkillTree::GetTypeColor()      const { return FColor(0, 200, 100); }
UClass* FAssetTypeActions_SkillTree::GetSupportedClass() const { return USkillTreeDataAsset::StaticClass(); }
uint32  FAssetTypeActions_SkillTree::GetCategories()           { return EAssetTypeCategories::Gameplay; }
